...
%>
 ...
 <br><br><br><br><br><br>
 <tr><center><font size="4" color="white">Welcome to <%=session.getAttribute("user") %></font></center></tr><!--
    <tr><center><font size="4" color="white">Welcome to TeachingAssistant</font></center></tr><
  --></body>
  <p>&nbsp;</p>
</html>