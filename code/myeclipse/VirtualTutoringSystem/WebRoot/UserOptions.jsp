...
function mmLoadMenus() {
  ...
  mm_menu_1224101012_0.addMenuItem("Add Municipalitys","location='MunicipalityMaster.jsp?list=admin'");
...
window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
  mm_menu_1224101649_0.addMenuItem("Add Corporations","location='MunicipalCorporation.jsp?header=list'"); 
  ...
  mm_menu_1224101802_0.addMenuItem("Add Grampanchayats","location='GramPanchayatMaster.jsp?header=list'");
...
<a href="userhome.jsp"  class="style1">Home</a>&nbsp;&nbsp;|
<a href="#"  class="style1" name="link7" id="link1" onMouseOver="MM_showMenu(window.mm_menu_1224101012_0,0,25,null,'link7')" onMouseOut="MM_startTimeout();" >Municipalities     </a>&nbsp;&nbsp;|
<a href="#" class="style1" name="link6" id="link2" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link6')" onMouseOut="MM_startTimeout();" >Corporations</a>&nbsp;&nbsp;|
 <a href="#" class="style1" name="link5" id="link3" onMouseOver="MM_showMenu(window.mm_menu_1224101802_0,0,25,null,'link5')" onMouseOut="MM_startTimeout();">GramPanchayats</a>&nbsp;&nbsp;|
...
<a href="LoginForm.jsp" class="style1" >Logout</a>
