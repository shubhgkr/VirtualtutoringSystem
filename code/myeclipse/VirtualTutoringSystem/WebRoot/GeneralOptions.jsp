...
function mmLoadMenus() {
  ...
  // mm_menu_1224101012_0.addMenuItem("View Municipalitys","location='ViewMunicipalityMaster.jsp?submit=ViewMunicipalitys'");
   ...
   mm_menu_1224101649_0.addMenuItem("View Announcements","location='./viewNewsLetter3.do'"); 
...
<a href="#"  class="style1" name="link7" id="link1" onMouseOver="MM_showMenu(window.mm_menu_1224101012_0,0,25,null,'link7')" onMouseOut="MM_startTimeout();" >Courses     </a>&nbsp;&nbsp;|
<a href="#" class="style1" name="link6" id="link2" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link6')" onMouseOut="MM_startTimeout();" >Announcements</a>&nbsp;&nbsp;|
...
<a href="#" name="link8" id="link8" class="style1" onMouseOver="MM_showMenu(window.mm_menu_1224122939_0,0,25,null,'link8')" onMouseOut="MM_startTimeout();">Facultys</a>&nbsp;&nbsp;|
