...
function mmLoadMenus() {
  if (window.mm_menu_1224101012_0) return;
     ...
     window.mm_menu_1224101012_0.addMenuItem("view Faculty","location='./viewFacultyMaster1.do'");
  ...
  window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
          mm_menu_1224101649_0.addMenuItem("Discuss","location='Chat.html'");
   ...
   window.mm_menu_1224101903_0 = new Menu("root",140,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
   mm_menu_1224101903_0.addMenuItem("sendQuery","location='./queries.do'");
   mm_menu_1224101903_0.addMenuItem("ViewQuery","location='./CustomerViewQuerys.do'");
  ...
  mm_menu_1224122939_0.addMenuItem("View Announcements","location='./viewNewsLetter1.do'");
...
-->
	...
	<body>
		...
		<a href="StudentHome.jsp" class="style1">Home</a>&nbsp;&nbsp;|
		...
		<a href="#" class="style1" name="link6" id="link2"
			...
			onMouseOut="MM_startTimeout();">DiscussionForum</a>&nbsp;&nbsp;|
		...
		<a href="#" name="link8" id="link8" class="style1"
			...
			onMouseOut="MM_startTimeout();">Announcements</a>&nbsp;&nbsp;|
		<a href="#" class="style1" name="link4" id="link4"
			onMouseOver="MM_showMenu(window.mm_menu_1224101903_0,0,25,null,'link4')"
			onMouseOut="MM_startTimeout();">Queries</a>&nbsp;&nbsp;|
		<a href="StudentChangePassword.jsp" class="style1"><strong>ResetPassword</strong>
		</a>&nbsp;&nbsp;|
