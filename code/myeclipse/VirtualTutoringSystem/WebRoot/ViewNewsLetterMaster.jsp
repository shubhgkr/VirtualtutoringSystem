...
<div align="right">
  ...
  <%
   ...
   %>
	...
	<center><h3><font color="white">Announcement Details</h3></center>
...
<%
	while (en.hasMoreElements()) {
			NewsLetterMasterForm form = (NewsLetterMasterForm) en
					.nextElement();
%>
...
<td><b> <font color="#ffff00"><%=form.getNewsdate()%><!--<a href="UpdateNewsLetterMaster.jsp?Id="><font color="#ffff00"></a>-->
												<u></td>
