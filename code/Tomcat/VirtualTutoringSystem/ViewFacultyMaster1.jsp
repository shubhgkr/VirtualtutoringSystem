			...
			<table border=1 bordercolor="white" width="695" height="450"
				...
				<tr>
					<td bgcolor="white" height="10" width="750">
						...
						<center><jsp:include page="Options.jsp" /></center>
					</td>
				</tr>
				...
				<td valign="top" width="617">
					...
					<div align="right">
						...
						<center>
							<h3>
								<font color="white">Faculty Details 
							</h3>
						</center>
						<table width="357" height="260" border="0"
							...
							<table align="center" border="1">
								<tr>
									...
									<th>
										<font color="white">Dob 
									</th>
									<th>
										<font color="white">Dor 
									</th>
									<th>
										<font color="white">Addr 
									</th>
									<th>
										<font color="white">Email 
									</th>
									<th>
										<font color="white">Phone 
									</th>
									<th>
										<font color="white">Image 
									</th>
									<th>
										<font color="white">Remark 
									</th>
									<th>
										<font color="white">Exp 
									</th>
								</tr>
								<%
									while (en.hasMoreElements()) {
											FacultyMasterForm form = (FacultyMasterForm) en
													.nextElement();
								%>
								<tr>
									<td>
										<b><font color="#ffff00"><u><%=form.getFacultyfirstname()%>
									</td>
									<td>
										<b><font color="#ffff00"><%=form.getDob()%>
									</td>
									<td>
										<b><font color="#ffff00"><%=form.getDor()%>
									</td>
									<td>
										<b><font color="#ffff00"><%=form.getAddress()%>
									</td>
									<td>
										<b><font color="#ffff00"><%=form.getEmail()%>
									</td>
									<td>
										<b><font color="#ffff00"><%=form.getPhone()%>
									</td>
									<td>
										<img src="images/<%=form.getImage()%>" height=50 width=100>
									</td>
									<td align="center">
										<b><font color="#ffff00"><%=form.getSpecialRemarks()%>
									</td>
									<td>
										<b><font color="#ffff00"><%=form.getExperience()%>
									</td>
								</tr>
								<%
									}
