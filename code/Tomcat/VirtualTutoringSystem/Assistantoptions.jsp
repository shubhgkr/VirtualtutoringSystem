...
function mmLoadMenus() {
 ...
 // mm_menu_1224101903_0.addMenuItem("View Dealer Orders","location='UpdateDealerOrder.jsp'");-->
   ...
   mm_menu_1224101903_0.addMenuItem("view Queries","location='ViewQueries.jsp'");
...
<a href="AssistantHome.jsp"  class="style1">Home</a>&nbsp;&nbsp;|
<a href="ViewCourseMaster.jsp"  class="style1" name="link7" id="link1" onMouseOver="MM_showMenu(window.mm_menu_1224101012_0,0,25,null,'link7')" onMouseOut="MM_startTimeout();" >Courses     </a>&nbsp;&nbsp;|
<a href="#" class="style1" name="link6" id="link2" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link6')" onMouseOut="MM_startTimeout();" >NewsLetter</a>&nbsp;&nbsp;|
 <a href="#" class="style1" name="link5" id="link3" onMouseOver="MM_showMenu(window.mm_menu_1224101802_0,0,25,null,'link5')" onMouseOut="MM_startTimeout();">Students</a>&nbsp;&nbsp;|
<%--<a href="ViewQueries.jsp" class="style1" >Queries</a>&nbsp;&nbsp;|&nbsp;&nbsp;--%>
<a href="#" name="link4" id="link4" class="style1" onMouseOver="MM_showMenu(window.mm_menu_1224101903_0,0,25,null,'link4')" onMouseOut="MM_startTimeout();">Queries</a>&nbsp;&nbsp;|
<a href="#" name="link8" id="link8" class="style1" onMouseOver="MM_showMenu(window.mm_menu_1224122939_0,0,25,null,'link8')" onMouseOut="MM_startTimeout();">Faculty</a>&nbsp;&nbsp;|
